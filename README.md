...
To install, you can visit [NuGet (https://www.nuget.org/packages/TS.ERPServer)](https://www.nuget.org/packages/TS.ERPServer/)
...
After the installation is complete, you can view the VS2022 project list with `dotnet new list` and search for the project template "ASP.NET Clean Architecture Solution" with the short name "ts.erpserver". If you find it in the list, you can now create a new project via VS2022 and find it by searching for "Clean Architecture" in the project search bar.
